...
int main(int argc, char *argv[]) {
    ...
    while ((entry = readdir(dir)) != NULL) {
         ...
         *       the filename and inode number to which it is mapped, and the
         *       entries are in no particular order. Once we have the filename,
         *       any additional information can be queried with "stat". */
